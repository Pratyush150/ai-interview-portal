 ...
 *
 * The product brand is APERTURE. Edit this file (and only this file) to
 * rename, change the support email, or set the production domain.
 */
...
export const BRAND_DOMAIN = "aperture.demo";

// Internal sales address — receives lead-notification emails.
export const SUPPORT_EMAIL = "sales@aperture.demo";
export const CONTACT_EMAIL = "hello@aperture.demo";
